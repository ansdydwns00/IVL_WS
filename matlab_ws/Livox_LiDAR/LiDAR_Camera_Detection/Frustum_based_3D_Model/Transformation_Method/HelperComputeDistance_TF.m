function [Model, ModelInfo] = HelperComputeDistance_TF(bboxes, id, cls, isTracking, ptCld)
    
    
Model = {};
ModelInfo = struct('BoxCenter', [], 'BoxSize', [], 'BoxOrientation', [], 'Distance', [], 'ID', [], 'Class', [], 'Obj_isTracking',[]);
